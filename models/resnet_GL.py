...
def resnet32_gl(pretrained=False, path=None, **kwargs):
    """
...
def resnet110_gl(pretrained=False, path=None, **kwargs):
    """
...
def wide_resnet20_8_gl(pretrained=False, progress=True, **kwargs):
...
if __name__ == '__main__':
    ...
    net = resnet32_gl(num_classes=100)
    logit = net(x)
